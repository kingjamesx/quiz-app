...
const Qualities = () => {
  return (
    <section className="border-t bg-techskills-pattern bg-cover px-5 lg:px-20 sm:px-10 pb-[100px] mt-[100px] pt-[100px] flex flex-col-reverse md:flex-row justify-between items-center">
      {/* left side */}
      <div className="flex">
      ...
      <div className="relative">
        ...
        <p className="text-[#048481] text:xs md:text-base">Qualities</p>
        <h4 className="font-[700] text-2xl leading-9 md:text-[40px] md:leading-[56px] text-[#292627]">Tech Skills</h4>
        <p className="text-sm md:text-lg leading-6 mt-4 text-[#5D5658] md:max-w-[600px]">
